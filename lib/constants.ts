...
export const navItems = [
  ...
  { href: "/communication-center", label: "Communication Center", icon: MessagesSquare, roles: ["ADMIN", "MANAGER", "USER"] },
  ...
  { href: "/lead-distribution", label: "Lead Distribution", icon: Shuffle, roles: ["ADMIN"] },
